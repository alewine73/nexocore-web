...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-gray-300 font-sans selection:bg-yellow-500/30">
      ...
      <section className="relative min-h-screen pt-32 pb-20 md:pt-40 md:pb-32 px-6 overflow-hidden flex items-center">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
            ...
            <a href="#casos-exito" className="hidden px-8 py-5 border-2 border-yellow-500 text-yellow-500 font-bold rounded-full text-lg hover:bg-yellow-500/10 transition-all transform hover:scale-105 flex items-center justify-center gap-2">
              <Award size={20} />
              Ver Casos de Éxito
            </a>
          </div>
      ...
      {/* --- SECCIÓN POSIBLES SOLUCIONES (PROBLEMAS COMUNES) --- */}
      <section className="py-32 px-6 bg-black relative overflow-hidden border-t border-yellow-500/10">
        {/* Efectos de fondo */}
        <div className="absolute top-0 left-1/3 w-[500px] h-[500px] bg-yellow-600/5 blur-[100px] rounded-full pointer-events-none animate-blob"></div>
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-blue-600/5 blur-[100px] rounded-full pointer-events-none animate-blob" style={{animationDelay: '3s'}}></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
              Soluciones para tus <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-yellow-500 to-amber-600">Principales Desafíos</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Estos son los problemas más comunes que encuentran nuestros clientes. Aquí están las soluciones probadas.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            {/* Solución 1: Costes Operativos Altos */}
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 to-transparent rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              
              <div className="relative bg-gradient-to-br from-red-900/20 to-black border border-red-500/30 p-8 rounded-2xl hover:border-red-500/60 transition-all duration-300">
                
                <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-red-500/50 to-transparent"></div>

                <div className="flex items-start gap-4 mb-6">
                  <div className="relative">
                    <div className="absolute inset-0 bg-red-500/20 blur-lg rounded-lg"></div>
                    <div className="relative h-14 w-14 bg-gradient-to-br from-red-400 to-red-600 rounded-lg flex items-center justify-center shadow-lg">
                      <span className="text-2xl">💸</span>
                    </div>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white">Costes Operativos Muy Altos</h3>
                    <p className="text-xs text-red-300">Márgenes cada vez más ajustados</p>
                  </div>
                </div>

                <p className="text-gray-300 mb-6 leading-relaxed">
                  Demasiada gente en nómina haciendo tareas repetitivas. Los gastos se comen las ganancias.
                </p>

                <div className="space-y-3 mb-8">
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-red-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Automatización IA de procesos repetitivos</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-red-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Sistemas inteligentes 24/7 sin pausa</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-red-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Reducción de costes hasta 70%</span>
                  </div>
                </div>

                <div className="text-sm font-bold text-red-400">
                  📌 Resultado: Los mismos ingresos con nómina 50-70% menor
                </div>
              </div>
            </div>

            {/* Solución 2: Bajo Crecimiento de Ventas */}
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 to-transparent rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              
              <div className="relative bg-gradient-to-br from-orange-900/20 to-black border border-orange-500/30 p-8 rounded-2xl hover:border-orange-500/60 transition-all duration-300">
                ...
                <div className="flex items-start gap-4 mb-6">
                  <div className="relative">
                    ...
                    <div className="relative h-14 w-14 bg-gradient-to-br from-orange-400 to-orange-600 rounded-lg flex items-center justify-center shadow-lg">
                      <span className="text-2xl">📉</span>
                    </div>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white">Ventas Estancadas</h3>
                    <p className="text-xs text-orange-300">Crecimiento lento o nulo mes a mes</p>
                  </div>
                </div>

                <p className="text-gray-300 mb-6 leading-relaxed">
                  Aunque tengas producto/servicio bueno, no llega a los clientes indicados o el funnel no convierte.
                </p>

                <div className="space-y-3 mb-8">
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-orange-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Marketing digital estratégico con ROI medible</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-orange-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Funnels de venta optimizados para conversión</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-orange-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Leads cualificados + cierre automático</span>
                  </div>
                </div>

                <div className="text-sm font-bold text-orange-400">
                  📌 Resultado: Triplicar ventas en 3-6 meses
                </div>
              </div>
            </div>

            {/* Solución 3: Procesos Manuales Caóticos */}
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-transparent rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              
              <div className="relative bg-gradient-to-br from-purple-900/20 to-black border border-purple-500/30 p-8 rounded-2xl hover:border-purple-500/60 transition-all duration-300">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">Procesos Manuales y Desorganizados</h3>
                    <p className="text-xs text-purple-300">Errores humanos, duplicación, ineficiencia</p>
                  </div>
                </div>

                <p className="text-gray-300 mb-6 leading-relaxed">
                  Todo se hace a mano, sin sistemas. Hay inconsistencias, retrasos y el equipo está siempre abrumado.
                </p>

                <div className="space-y-3 mb-8">
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-purple-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Agentes IA que procesan datos automáticamente</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-purple-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Workflows inteligentes e integrados</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-purple-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Reducción 85% de errores y retrasos</span>
                  </div>
                </div>

                <div className="text-sm font-bold text-purple-400">
                  📌 Resultado: Operaciones fluidas y escalables
                </div>
              </div>
            </div>

            {/* Solución 4: Falta de Escalabilidad */}
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-transparent rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              
              <div className="relative bg-gradient-to-br from-green-900/20 to-black border border-green-500/30 p-8 rounded-2xl hover:border-green-500/60 transition-all duration-300">
                
                <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-green-500/50 to-transparent"></div>

                <div className="flex items-start gap-4 mb-6">
                  <div className="relative">
                    <div className="absolute inset-0 bg-green-500/20 blur-lg rounded-lg"></div>
                    <div className="relative h-14 w-14 bg-gradient-to-br from-green-400 to-green-600 rounded-lg flex items-center justify-center shadow-lg">
                      <span className="text-2xl">📈</span>
                    </div>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-white">No Puede Escalar Sin Quebrar</h3>
                    <p className="text-xs text-green-300">Cada cliente nuevo = más costes y complejidad</p>
                  </div>
                </div>

                <p className="text-gray-300 mb-6 leading-relaxed">
                  El negocio crece pero el equipo y los costes explotan. No hay margen para invertir en crecimiento.
                </p>

                <div className="space-y-3 mb-8">
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-green-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Infraestructura IA que crece sin costes lineales</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-green-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Sistemas que manejan 10x volumen sin parar</span>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-black/40 rounded-lg">
                    <span className="text-green-400 font-bold flex-shrink-0">✓</span>
                    <span className="text-sm text-gray-300">Márgenes se mantienen o mejoran al crecer</span>
                  </div>
                </div>

                <div className="text-sm font-bold text-green-400">
                  📌 Resultado: Crecimiento exponencial sin limite
                </div>
              </div>
            </div>
          ...
          {/* CTA CENTRAL */}
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/10 via-transparent to-yellow-500/10 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
            
            <div className="relative bg-gradient-to-r from-yellow-900/30 via-black to-yellow-900/30 border border-yellow-500/30 rounded-3xl p-12 text-center overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-yellow-500/50 to-transparent"></div>
              
              <h3 className="text-3xl font-bold text-white mb-4">¿Tu negocio enfrenta alguno de estos desafíos?</h3>
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
                Tenemos la solución. Sin promesas vacías. Sin cobros por adelantado. Solo resultados medibles.
              </p>
