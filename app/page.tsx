...
export default function Home() {
  ...
  <div className="hidden md:flex items-center gap-8">
    ...
    <a href="#contacto" className="bg-white text-black px-6 py-2 rounded-full font-bold hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105 shadow-[0_0_15px_rgba(255,255,255,0.2)]">
      Agendar Auditoría
    </a>
  </div>
</div>
